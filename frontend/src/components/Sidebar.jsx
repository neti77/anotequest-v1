...
import { FolderPlus, Folder, Trash2, StickyNote } from 'lucide-react';
...
export const Sidebar = ({ folders, activeFolder, setActiveFolder, addFolder, deleteFolder, noteCount }) => {
    ...
    <div className="w-64 border-r border-border bg-card/50 backdrop-blur-sm flex flex-col">
      <div className="p-4 border-b border-border">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-semibold text-sm font-display">Folders</h2>
          <Button
            variant="ghost"
            size="icon"
