...
const styles = StyleSheet.create({
  ...
  // Vertical Drawing Toolbar (like frontend)
  ...
  verticalDrawingToolButtonActive: {
    backgroundColor: '#8b5cf6',
  },
  verticalBrushButton: {
    width: 36,
